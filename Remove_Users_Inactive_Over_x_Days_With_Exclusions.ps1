...
# Get user profiles where the following are true. It is not a special account, not currently logged in, last login over $AccountAgeOver days ago, and not one of the pre-defined/excluded accounts
